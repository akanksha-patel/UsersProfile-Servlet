...
public class PersonalDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("contactDetail.html");
	...
	private void createProfile(HttpSession session , String name ,String fName , String mName , String gender , List<String> hobby ,
			Date dob , String email , String occupation , String nationality){
		...
		if(session!=null && session.getAttribute("personalDetail")!=null){
			...
			PersonalDetail personalDetail = new PersonalDetail(name, fName, mName, gender, hobby, dob, email, occupation, nationality);
			session.setAttribute("personalDetail", personalDetail);
		}
